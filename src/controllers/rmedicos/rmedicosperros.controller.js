...
//metodos para los registros medicos de perros del albergue

const getsRmedicosPerros = async (req, res) => {
    try {
...
const getRmedicoPerro = async (req, res) => {
    try {
        ...
        WHERE id_dato_medico = ${id} AND tipo_animal = 'perro';`);
        res.json(result);
    } catch (error) {
        res.status(500);
        res.send(error.message);
...
const addRmedicoPerro = async (req, res) => {
    try {
        console.log(req.params);
...
const updateRmedicoPerro = async (req, res) => {
    try {
...
const deleteRmedicoPerro = async (req, res) => {
    try {
        console.log(req.params);
        const { id } = req.params;
        const connection= await getConnection();
